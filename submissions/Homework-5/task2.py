...
def parse_hotellist_page(html):
    ...
    for hotel_box in hotel_boxes:
        ...
        log.info("Traveler rating for excellent: %s" % ratings[0])
        log.info("Traveler rating for very good: %s" % ratings[1])
        log.info("Traveler rating for average: %s" % ratings[2])
        log.info("Traveler rating for poor: %s" % ratings[3])
        log.info("Traveler rating for terrible: %s" % ratings[4])
        ...
        log.info("See reviews for families: %s" % reviews[0])
        log.info("See reviews for couples: %s" % reviews[1])
        log.info("See reviews for solo: %s" % reviews[2])
        log.info("See reviews for business: %s" % reviews[3])
        ...
        log.info("Rating summary for sleep quality: %s" % summaries[0])
        log.info("Rating summary for location: %s" % summaries[1])
        log.info("Rating summary for rooms: %s" % summaries[2])
        log.info("Rating summary for service: %s" % summaries[3])
        log.info("Rating summary for value: %s" % summaries[4])
        log.info("Rating summary for cleanliness: %s" % summaries[5])      
